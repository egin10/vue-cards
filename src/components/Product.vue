  ...
  <div class="product">
    <div :class="'product-inner ' + product.color">
      ...
      <div class="product-image-wrap">
        <img :src="product.src" :alt="product.src" class="image" />
      </div>
      <div class="product-detail">
        <h2>{{ product.title }}</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex aliquam nulla aperiam fugiat fuga sed incidunt excepturi voluptates adipisci exercitationem?</p>
      </div>
    </div>
  </div>
</template>
